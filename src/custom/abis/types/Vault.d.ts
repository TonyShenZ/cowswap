...
export type AddDebtEvent = TypedEvent<
  [BigNumber, BigNumber] & { id: BigNumber; debtShare: BigNumber }
>;
...
export type WorkEvent = TypedEvent<
  [BigNumber, BigNumber] & { id: BigNumber; loan: BigNumber }
>;
...
export class Vault extends BaseContract {
  ...
  filters: {
    ...
    "AddDebt(uint256,uint256)"(
      ...
      [BigNumber, BigNumber],
      { id: BigNumber; debtShare: BigNumber }
    >;
