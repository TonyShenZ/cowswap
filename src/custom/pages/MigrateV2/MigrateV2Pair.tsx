...
import { AutoRow, RowBetween, RowFixed } from '@src/components/Row'
import { V2_FACTORY_ADDRESSES } from '@src/constants/addresses'
import { WETH9_EXTENDED } from '@src/constants/tokens'
import { useToken } from '@src/hooks/Tokens'
import { usePairContract, useV2MigratorContract } from '@src/hooks/useContract'
import { useV2LiquidityTokenPermit } from '@src/hooks/useERC20Permit'
import useIsArgentWallet from '@src/hooks/useIsArgentWallet'
import { useTotalSupply } from '@src/hooks/useTotalSupply'
import { useActiveWeb3React } from '@src/hooks/web3'
import { NEVER_RELOAD, useSingleCallResult } from '@src/state/multicall/hooks'
import { TransactionType } from '@src/state/transactions/actions'
import { useTokenBalance } from '@src/state/wallet/hooks'
import { BackArrow, ExternalLink, TYPE } from '@src/theme'
