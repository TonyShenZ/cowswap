...
import { TransactionSummary } from '@src/components/AccountDetails/TransactionSummary'
import { Wrapper } from './TransactionConfirmationModalMod'
...
export default function TransactionConfirmationUniversalModal({
  isOpen,
  onDismiss,
  attemptingTxn,
  hash,
