...
import LimitModalFooter from 'components/swap/LimitModalFooter'
import LimitModalHeader from 'components/swap/LimitModalHeader'
// MOD
...
export default function ConfirmSwapModal({
  ...
  const modalBottom = useCallback(() => {
    return trade ? (
      <LimitModalFooter onConfirm={onConfirm} disabledConfirm={showAcceptChanges} swapErrorMessage={swapErrorMessage} />
    ) : null
  ...
  const confirmationContent = useCallback(
    () =>
      swapErrorMessage ? (
        ...
        <ConfirmationModalContent
          title={<Trans>Confirm Limit</Trans>}
          onDismiss={onDismiss}
